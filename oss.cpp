...
struct MsgBuf {
    ...
    int result;         // used by worker to tell OSS how much of quantum it used
                            // +: # of nanoseconds process ran before interrupted/blocked
                            // -: process terminated after using some time
};
...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    alarm(3);          // set timer to send SIGALRM singal after 3 real time seconds    
